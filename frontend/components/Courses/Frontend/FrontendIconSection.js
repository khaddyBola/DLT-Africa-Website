...
const secData = [
  {
    id: 1,
    title: "Duration",
    text: "4 months Changed from text to text2 to match the data Changed from text to text2 to match the data",
    ...
    iconBodyClass: " p-6  w-[229px] h-[241px] border-2 rounded-[10px] flex ",
    iconsClass: "text-[65px] text-[#C54809] mb-[30px]", // Example class for icon size
    titleClass: "text-[22px] font-normal text-[#1C1C1C]", // Example class for title
    textClass: "text-sm text-[#1C1C1C]", // Example class for text
  },
  {
    id: 2,
    title: "Date",
    ...
    iconBodyClass: "text-white p-6  w-[229px] h-[241px] border-2 rounded-[10px] flex",
    iconsClass: "text-[65px] text-[#C54809] mb-[30px]", // Example class for icon size
    titleClass: "text-[22px] font-normal text-[#1C1C1C]", // Example class for title
    textClass: "text-sm text-[#1C1C1C]", // Example class for text
  },
  ...
  },
  {
    ...
    icon: <BsLayoutWtf/>, 
    courseConClass: "py-2 px-30 flex flex-row items-center justify-center ", // Different class for the second item
    iconBodyClass: "text-red-700 p-6 w-[229px] h-[241px] border-2 rounded-[10px] flex",
    iconsClass: "text-[65px] text-[#C54809] mb-[30px]", // Example class for icon size
    titleClass: "text-[22px] font-normal text-[#1C1C1C]", // Example class for title
    textClass: "text-sm text-[#1C1C1C]", // Example class for text
  },
...
const FrontendIconSection = () => {
    ...
    <div className="iconsCon grid grid-cols-3 gap-4 items-centre justify-center flex">
