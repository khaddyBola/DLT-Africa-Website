  ...
  return (
    <footer className="w-[1500px] h-[469px] bg-[#EFFFE2] flex flex-col items-center justify-center text-[18px]">
      ...
      <div className="flex gap-6 pb-5 justify-center mt-[80px] ">
        <a href="#"><FaFacebook className="w-[35px] h-[35px]" /></a>
        <a href="#"><FaInstagram className="w-[35px] h-[35px]" /></a>
        <a href="#"><FaLinkedin className="w-[35px] h-[35px]" /></a>
        <a href="#"><FaTwitter className="w-[35px] h-[35px]" /></a>
        <a href="#"><FaGithub className="w-[35px] h-[35px]" /></a>
      </div>
    </footer>
  );
};
